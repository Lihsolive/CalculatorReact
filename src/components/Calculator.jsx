    ...
    <div>
      ...
      <Container maxWidth="xs">
        <div className="wrapper">
          ...
          <button className="red" onClick={operatorHandler} value={"/"}>
            /
          </button>
          ...
          <button className="red" onClick={operatorHandler} value={"x"}>
            X
          </button>
          ...
          <button className="gray_zero" onClick={inputNum} value={0}>
            0
          </button>
          <button className="gray" onClick={inputNum} value={"."}>
            .
          </button>
          <button className="red" onClick={calculate}>
            =
          </button>
        </div>
      </Container>
